"""Paired closed-loop load sweep; uses the unmodified application evaluator.

Only isolated application capacity is raised. Models/serving options stay fixed.
Partial and safety-stopped cells are not reported as completed measurements.
"""
import argparse
import asyncio
import hashlib
