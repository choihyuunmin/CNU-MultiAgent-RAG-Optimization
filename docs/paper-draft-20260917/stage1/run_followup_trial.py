...
async def run(args):
    ...
    count = args.smoke_count if args.smoke else 200
            ...
            for mode in methods:
                ...
                try:
                    ...
                    command = [sys.executable, "/opt/cnu/run_rag_experiment.py",
                               ...
                               "--concurrency", str(args.concurrency), "--repeats", "1",
...
if __name__ == "__main__":
    ...
    p.add_argument('--smoke-count', type=int, default=1, help='questions in the smoke file (protocol stage 1 uses 20)')
