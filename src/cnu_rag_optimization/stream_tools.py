"""Overlap committed tool calls with generation, without guessing JSON completion.

The provider adapter must emit CallReady only when arguments are immutable.
Chat-completion argument deltas or a closing brace alone are NOT this signal.
No provider adapter or production installation is implied by this module.
"""
