"""Fail-closed, order-independent audits of prepared tool executions.

No prompts or outputs are retained. Hash equality is an observation, not proof
of semantic correctness. Cross-run matching never uses output hashes to align
branches: repeated identical inputs are ambiguous without a stable logical key.
"""
