"""FIFO pipeline admission driven by serving pressure, without changing requests.

This is an experimental outer gate. It cannot replace the model scheduler or
promise a latency gain. Callers must include time spent here in user latency.
"""
